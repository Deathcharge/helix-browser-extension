...
async function analyze() {
  ...
  try {
    ...
    display(HelixAnalyzer.analyzePage(snapshot));
...
function exportJson() {
  ...
  link.href = url; link.download = `helix-page-lens-${Date.now()}.json`; link.click(); URL.revokeObjectURL(url);
}
