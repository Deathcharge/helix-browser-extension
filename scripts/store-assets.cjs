...
const assets = [
  {
    file: '01-private-source-triage.png', eyebrow: 'PRIVATE SOURCE TRIAGE',
    title: 'See the page’s signals before you trust the page.',
    body: 'Reading effort, structure, bylines, dates, citations, and linked source domains—processed on-device with no account or page upload.',
    badges: ['ON-DEVICE', 'NO ACCOUNT', 'NO REMOTE AI'], image: source('page-lens-comparison.png'), mode: 'device'
  },
  {
