...
- Use the unsigned [v1.8.3-pilot.1 prerelease](https://github.com/Deathcharge/samsarix-page-lens/releases/tag/v1.8.3-pilot.1) artifact `samsarix-page-lens-1.8.3.zip` with SHA-256 `6B32B111B40552F6FCEC840711344B2BC0FEE19E74E6957E6B06B6346A04FA83`. Do not silently substitute another build.
...
Copy this section into a dated `docs/pilots/YYYY-MM-DD-1.8.3.md` file after the pilot. Commit no raw responses.
